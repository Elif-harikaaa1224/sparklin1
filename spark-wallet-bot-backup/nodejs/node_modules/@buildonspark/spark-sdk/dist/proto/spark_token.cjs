...
var PageRequest = {
  ...
  fromJSON(object) {
    return {
      pageSize: isSet2(object.pageSize) ? globalThis.Number(object.pageSize) : 0,
      cursor: isSet2(object.cursor) ? globalThis.String(object.cursor) : "",
      direction: isSet2(object.direction) ? directionFromJSON(object.direction) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var PageResponse = {
  ...
  fromJSON(object) {
    return {
      hasNextPage: isSet2(object.hasNextPage) ? globalThis.Boolean(object.hasNextPage) : false,
      hasPreviousPage: isSet2(object.hasPreviousPage) ? globalThis.Boolean(object.hasPreviousPage) : false,
      nextCursor: isSet2(object.nextCursor) ? globalThis.String(object.nextCursor) : "",
      previousCursor: isSet2(object.previousCursor) ? globalThis.String(object.previousCursor) : ""
    };
  },
  toJSON(message) {
    const obj = {};
...
var QueryTokenOutputsRequest = {
  ...
  fromJSON(object) {
    return {
      ...
      tokenIdentifiers: globalThis.Array.isArray(object?.tokenIdentifiers) ? object.tokenIdentifiers.map((e) => bytesFromBase642(e)) : [],
      network: isSet3(object.network) ? networkFromJSON(object.network) : 0,
      pageRequest: isSet3(object.pageRequest) ? PageRequest.fromJSON(object.pageRequest) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
  ...
  fromPartial(object) {
    ...
    message.tokenIdentifiers = object.tokenIdentifiers?.map((e) => e) || [];
    message.network = object.network ?? 0;
    message.pageRequest = object.pageRequest !== void 0 && object.pageRequest !== null ? PageRequest.fromPartial(object.pageRequest) : void 0;
    return message;
  }
};
...
var QueryTokenOutputsResponse = {
  encode(message, writer = new import_wire5.BinaryWriter()) {
    ...
    if (message.pageResponse !== void 0) {
  ...
  fromJSON(object) {
    return {
      ...
      pageResponse: isSet3(object.pageResponse) ? PageResponse.fromJSON(object.pageResponse) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
  ...
  fromPartial(object) {
    ...
    message.pageResponse = object.pageResponse !== void 0 && object.pageResponse !== null ? PageResponse.fromPartial(object.pageResponse) : void 0;
    return message;
  }
};
