...
`,
    variables: { id },
    constructObject: (data) => (0, import_core35.isObject)(data) && "entity" in data && (0, import_core35.isObject)(data.entity) ? UmaCurrencyFromJson(data.entity) : null
  };
};
...
`,
    variables: { id },
    constructObject: (data) => (0, import_core36.isObject)(data) && "entity" in data && (0, import_core36.isObject)(data.entity) ? UmaInvitationFromJson(data.entity) : null
  };
};
