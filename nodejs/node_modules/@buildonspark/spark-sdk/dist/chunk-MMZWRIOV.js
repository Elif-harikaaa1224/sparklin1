...
`,
    variables: { id },
    constructObject: (data) => isObject(data) && "entity" in data && isObject(data.entity) ? ClaimStaticDepositFromJson(data.entity) : null
  };
};
...
`,
    variables: { id },
    constructObject: (data) => isObject2(data) && "entity" in data && isObject2(data.entity) ? CoopExitFeeQuoteFromJson(data.entity) : null
  };
};
