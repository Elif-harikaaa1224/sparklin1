...
declare class Account implements LightsparkNodeOwner, Entity {
    ...
    getTransactions(client: LightsparkClient, first?: number | undefined, after?: string | undefined, types?: TransactionType[] | undefined, afterDate?: string | undefined, beforeDate?: string | undefined, bitcoinNetwork?: BitcoinNetwork | undefined, lightningNodeId?: string | undefined, statuses?: TransactionStatus[] | undefined, excludeFailures?: TransactionFailures | undefined, maxAmount?: CurrencyAmountInput | undefined, minAmount?: CurrencyAmountInput | undefined): Promise<AccountToTransactionsConnection>;
    getPaymentRequests(client: LightsparkClient, first?: number | undefined, after?: string | undefined, afterDate?: string | undefined, beforeDate?: string | undefined, bitcoinNetwork?: BitcoinNetwork | undefined, lightningNodeId?: string | undefined, maxAmount?: CurrencyAmountInput | undefined, minAmount?: CurrencyAmountInput | undefined): Promise<AccountToPaymentRequestsConnection>;
    getWithdrawalRequests(client: LightsparkClient, first?: number | undefined, after?: string | undefined, bitcoinNetworks?: BitcoinNetwork[] | undefined, statuses?: WithdrawalRequestStatus[] | undefined, nodeIds?: string[] | undefined, idempotencyKeys?: string[] | undefined, afterDate?: string | undefined, beforeDate?: string | undefined, maxAmount?: CurrencyAmountInput | undefined, minAmount?: CurrencyAmountInput | undefined): Promise<AccountToWithdrawalRequestsConnection>;
...
declare class LightsparkClient {
     ...
     */
    createOffer(nodeId: string, amountMsats: number, description: string): Promise<string | undefined>;
    /**
     ...
     */
    payInvoice(payerNodeId: string, encodedInvoice: string, maximumFeesMsats: number, timeoutSecs?: number, amountMsats?: number | undefined, idempotencyKey?: string | undefined): Promise<OutgoingPayment | undefined>;
    /**
     ...
     * @returns An `OutgoingPayment` object if the payment was successful, or undefined if the payment failed.
     */
    payOffer(payerNodeId: string, encodedOffer: string, timeoutSecs: number, maximumFeeMsats: number, amountMsats?: number, idempotencyKey?: string): Promise<OutgoingPayment | undefined>;
    /**
...
declare const getOfferQuery: (id: string) => Query<Offer>;
...
declare const getOfferDataQuery: (id: string) => Query<OfferData>;
