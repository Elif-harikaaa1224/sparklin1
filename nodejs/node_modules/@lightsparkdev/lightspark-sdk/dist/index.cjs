...
__export(src_exports, {
  ...
  UmaInvitationStatus: () => UmaInvitationStatus_default,
  ...
  getUmaCurrencyQuery: () => getUmaCurrencyQuery,
...
var LightsparkClient = class {
   ...
   */
  async payInvoice(payerNodeId, encodedInvoice, maximumFeesMsats, timeoutSecs = 60, amountMsats = void 0, idempotencyKey = void 0) {
...
// src/webhooks.ts
var import_core42 = require("@lightsparkdev/core");
var WEBHOOKS_SIGNATURE_HEADER = "lightspark-signature";
var verifyAndParseWebhook = async (data, hexDigest, webhookSecret) => {
  ...
  if (
    ...
    digestBytes.length !== hexDigest.length / 2 || // timingSafeEqual checks this, but throws a different error.
    sig.length !== digestBytes.length || !timingSafeEqual(sig, digestBytes)
  ) {
