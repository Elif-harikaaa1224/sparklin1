...
declare const PageRequest: MessageFns$2<PageRequest>;
...
declare const PageResponse: MessageFns$2<PageResponse>;
/**
...
declare const RenewNodeTimelockSigningJob: MessageFns$2<RenewNodeTimelockSigningJob>;
...
declare const RenewNodeTimelockResult: MessageFns$2<RenewNodeTimelockResult>;
...
declare const SparkInvoiceFields: MessageFns$2<SparkInvoiceFields>;
interface SatsPayment {
    amount?: number | undefined;
}
declare const SatsPayment: MessageFns$2<SatsPayment>;
interface TokensPayment {
    tokenIdentifier?: Uint8Array | undefined;
    /** variable length uint128 */
    amount?: Uint8Array | undefined;
}
declare const TokensPayment: MessageFns$2<TokensPayment>;
...
declare const SatsTransfer: MessageFns$2<SatsTransfer>;
...
declare const UpdateWalletSettingResponse: MessageFns$2<UpdateWalletSettingResponse>;
interface QueryWalletSettingRequest {
}
declare const QueryWalletSettingRequest: MessageFns$2<QueryWalletSettingRequest>;
interface QueryWalletSettingResponse {
    walletSetting: WalletSetting | undefined;
}
declare const QueryWalletSettingResponse: MessageFns$2<QueryWalletSettingResponse>;
...
declare const SparkServiceDefinition: {
    ...
    readonly methods: {
        ...
        readonly update_wallet_setting: {
            readonly name: "update_wallet_setting";
            readonly requestType: MessageFns$2<UpdateWalletSettingRequest>;
            readonly requestStream: false;
            readonly responseType: MessageFns$2<UpdateWalletSettingResponse>;
            readonly responseStream: false;
            readonly options: {};
        };
        readonly query_wallet_setting: {
            readonly name: "query_wallet_setting";
            readonly requestType: MessageFns$2<QueryWalletSettingRequest>;
            readonly requestStream: false;
            readonly responseType: MessageFns$2<QueryWalletSettingResponse>;
            readonly responseStream: false;
            readonly options: {};
        };
    };
...
interface SparkServiceClient<CallOptionsExt = {}> {
    ...
    update_wallet_setting(request: DeepPartial$2<UpdateWalletSettingRequest>, options?: CallOptions & CallOptionsExt): Promise<UpdateWalletSettingResponse>;
    query_wallet_setting(request: DeepPartial$2<QueryWalletSettingRequest>, options?: CallOptions & CallOptionsExt): Promise<QueryWalletSettingResponse>;
}
...
declare class LightningService {
    ...
    providePreimage(preimage: Uint8Array): Promise<Transfer$1>;
}
...
declare class ReactNativeTaprootSparkSigner extends TaprootSparkSigner {
    constructor(useAddressIndex?: boolean);
    signFrost({ message, keyDerivation, publicKey, verifyingKey, selfCommitment, statechainCommitments, adaptorPubKey, }: SignFrostParams): Promise<Uint8Array>;
    aggregateFrost({ message, publicKey, verifyingKey, selfCommitment, statechainCommitments, adaptorPubKey, selfSignature, statechainSignatures, statechainPublicKeys, }: AggregateFrostParams): Promise<Uint8Array>;
}
