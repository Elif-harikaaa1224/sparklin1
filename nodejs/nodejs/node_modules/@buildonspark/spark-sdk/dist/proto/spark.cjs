...
var DepositAddressProof = {
  ...
  fromJSON(object) {
    return {
      addressSignatures: isObject(object.addressSignatures) ? Object.entries(object.addressSignatures).reduce((acc, [key, value]) => {
...
var SigningResult = {
  ...
  fromJSON(object) {
    return {
      publicKeys: isObject(object.publicKeys) ? Object.entries(object.publicKeys).reduce((acc, [key, value]) => {
        acc[key] = bytesFromBase642(value);
        return acc;
      }, {}) : {},
      signingNonceCommitments: isObject(object.signingNonceCommitments) ? Object.entries(object.signingNonceCommitments).reduce(
        (acc, [key, value]) => {
      ...
      signatureShares: isObject(object.signatureShares) ? Object.entries(object.signatureShares).reduce((acc, [key, value]) => {
        acc[key] = bytesFromBase642(value);
        return acc;
      }, {}) : {},
...
var TransferPackage = {
  ...
  fromJSON(object) {
    return {
      leavesToSend: globalThis.Array.isArray(object?.leavesToSend) ? object.leavesToSend.map((e) => UserSignedTxSigningJob.fromJSON(e)) : [],
      keyTweakPackage: isObject(object.keyTweakPackage) ? Object.entries(object.keyTweakPackage).reduce((acc, [key, value]) => {
        acc[key] = bytesFromBase642(value);
        return acc;
      }, {}) : {},
      userSignature: isSet3(object.userSignature) ? bytesFromBase642(object.userSignature) : new Uint8Array(0),
...
var SendLeafKeyTweak = {
  ...
  fromJSON(object) {
    return {
      ...
      pubkeySharesTweak: isObject(object.pubkeySharesTweak) ? Object.entries(object.pubkeySharesTweak).reduce((acc, [key, value]) => {
        acc[key] = bytesFromBase642(value);
        return acc;
      }, {}) : {},
...
var QueryTransfersResponse = {
  ...
  fromJSON(object) {
    return {
      transfers: globalThis.Array.isArray(object?.transfers) ? object.transfers.map((e) => Transfer.fromJSON(e)) : [],
      offset: isSet3(object.offset) ? globalThis.Number(object.offset) : 0
    };
  },
  toJSON(message) {
...
var SigningCommitments = {
  ...
  fromJSON(object) {
    return {
      signingCommitments: isObject(object.signingCommitments) ? Object.entries(object.signingCommitments).reduce(
        (acc, [key, value]) => {
          acc[key] = SigningCommitment.fromJSON(value);
          return acc;
        },
...
var QueryBalanceResponse = {
  ...
  fromJSON(object) {
    return {
      ...
      nodeBalances: isObject(object.nodeBalances) ? Object.entries(object.nodeBalances).reduce((acc, [key, value]) => {
...
0 && (module.exports = {
  ...
  ExitSingleNodeTreesRequest,
  ExitSingleNodeTreesResponse,
  ExitingTree,
  ExtendLeafRequest,
  ExtendLeafResponse,
  ...
  QueryNodesDistributionRequest,
  QueryNodesDistributionResponse,
  ...
  TransferLeaf,
  TransferPackage,
  TransferPackage_KeyTweakPackageEntry,
  TransferStatus,
  TransferType,
  TreeNode,
  TreeNodeIds,
